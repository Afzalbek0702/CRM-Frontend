					...
					<CardHeader className="pb-4">
						<div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
							...
							<Button
								...
								className="bg-linear-to-r from-emerald-400 to-teal-400 hover:from-emerald-500 hover:to-teal-500 text-black shadow-lg shadow-emerald-500/25 gap-2"
							>
								<FaMoneyBillWave className="h-4 w-4" /> Yangi to'lov
							</Button>
						</div>
					</CardHeader>
					<CardContent>
